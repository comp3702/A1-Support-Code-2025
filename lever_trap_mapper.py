...
def generate_schematic_format(env, mapping_grid):
    """
    Generate schematic format that can be added to level files.
    """
    print("\n# Schematic format for level file:")
    print("# Schematic")
    for row in mapping_grid:
        schematic_row = ""
        for cell in row:
